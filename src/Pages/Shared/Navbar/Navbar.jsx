...
const Navbar = () => {
     ...
     return (
          <div className='relative mt-1 '>
               ...
               <div className='fixed z-10 container'>
                    <div className='text-center  text-[14px] text-white rounded-xl bg-[#fdb64e] p-1'>
               ...
               <div className='flex justify-end '>
                    <button className='fixed  bg-[#6ea963] mt-[600px] z-10  rounded-full p-5'> <FaShoppingCart className='text-white  text-3xl relative'></FaShoppingCart> <span className='absolute text-white -mt-12 '>01 </span> </button>
               </div>
          </div>
     );
};
